...
const ShippingView: React.FC<props> = observer(({ ShippingFlow }) => {
  ...
  return (
    <div className="shippingView">
      <div
        className="shippingView__container"
        style={{ display: "flex", justifyContent: "space-between" }}
      >
        <div className="shippingView__left" style={{ flex: 0.6 }}>
          <div className="shippingView__shippingFlow">
            <ShippingFlow />
          </div>
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="shippingView__form"
          >
        ...
        <div className="shippingView__right" style={{ flex: 0.3 }}>
          <OrderSummary />
        </div>
      </div>
    </div>
